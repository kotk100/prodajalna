...
streznik.post('/prijava', function(zahteva, odgovor) {
  ...
  form.parse(zahteva, function (napaka1, polja, datoteke) {
    ...
    try {
      ...
      stmt.finalize();
      sporociloPrijava = "Stranka je bila uspešno registrirana.";
    } catch (err) {
      napaka2 = true;
      sporociloPrijava = "Prišlo je do napake pri registraciji nove stranke. Prosim preverite vnešene podatke in poskusite znova.";
    }
...
streznik.get('/prijava', function(zahteva, odgovor) {
  vrniStranke(function(napaka1, stranke) {
      vrniRacune(function(napaka2, racuni) {
        odgovor.render('prijava', {sporocilo: sporociloPrijava, seznamStrank: stranke, seznamRacunov: racuni});
        sporociloPrijava = "";
      }) 
    });
})
